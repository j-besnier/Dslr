...
# @Last Modified time: 2025-01-07 21:22:49
...
def main():
    ...
    if not os.path.exists('results/results_scatter'):
        os.makedirs('results/results_scatter')
    ...
    for i in range(len(numeric_columns)):
        for j in range(i + 1, len(numeric_columns)):
            ...
            plt.savefig(f'results/results_scatter/{numeric_columns[i]}_vs_{numeric_columns[j]}.png')
            plt.close()

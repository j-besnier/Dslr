...
# @Last Modified time: 2025-01-07 20:41:28
...
def main():
    ...
    if not os.path.exists('results/results_histograms'):
        os.makedirs('results/results_histograms')
    
    background_image = plt.imread('assets/background.png')
    prop = fm.FontProperties(fname='assets/ParryHotter.ttf')
    
    for column in numeric_columns:
        with PdfPages(f'results/results_histograms/{column}.pdf') as pdf:
            fig, ax = plt.subplots()
